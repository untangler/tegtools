...
This time without Mustache, which is not really much help.

=head1 TODO

  heredoc
  prompt
  make output txt based on name
...
complexe spreasheetverzamelingen
...
sub body {
  if $long {
    return qq:to/EOLONG/;
      ...
      We bieden uitdrukkelijk geen Excelondersteuning; daar zijn allerlei expertisebureaus voor.
      Nee, wij bieden een traject aan waarbij we het materiaal aan een geautomatiseerde analyze en scan onderwerpen.
